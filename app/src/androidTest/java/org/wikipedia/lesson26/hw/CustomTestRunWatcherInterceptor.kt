...
class CustomTestRunWatcherInterceptor(
    private val testLogger: UiTestLogger
) : TestRunWatcherInterceptor {

    override fun onTestStarted(testInfo: TestInfo) {
        testLogger.d("KASPRESSO", "TEST STARTED")
    }

    override fun onBeforeSectionStarted(testInfo: TestInfo) {
        testLogger.d("KASPRESSO", "BEFORE SECTION STARTED")
    }

    override fun onBeforeSectionFinishedSuccess(testInfo: TestInfo) {
        testLogger.d("KASPRESSO", "BEFORE SECTION FINISHED SUCCESS")
    }

    override fun onMainSectionStarted(testInfo: TestInfo) {
        testLogger.d("KASPRESSO", "MAIN SECTION STARTED")
    }

    override fun onMainSectionFinishedSuccess(testInfo: TestInfo) {
        testLogger.d("KASPRESSO", "MAIN SECTION FINISHED SUCCESS")
    }

    override fun onAfterSectionStarted(testInfo: TestInfo) {
        testLogger.d("KASPRESSO", "AFTER SECTION STARTED")
    }

    override fun onAfterSectionFinishedSuccess(testInfo: TestInfo) {
        testLogger.d("KASPRESSO", "AFTER SECTION FINISHED SUCCESS")
    }

    override fun onTestFinished(testInfo: TestInfo, success: Boolean) {
        testLogger.d("KASPRESSO", "TEST FINISHED")
    }
}